...
# download URLs
export PANEL_DL_URL="https://github.com/jexactyl/jexactyl/releases/latest/download/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/AartDevelopment/jexactyl-installer"}
